...
public class MailPage extends Page{
	...
	{
		logger.debug("Messages selection is started");
		...
		logger.warn("Message selection is completed. Number of required selected message is less than available messages");
		return false;
	}
}
