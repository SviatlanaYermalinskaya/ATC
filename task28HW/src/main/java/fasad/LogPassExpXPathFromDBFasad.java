...
public class LogPassExpXPathFromDBFasad 
{
	private static final Logger logger = Logger.getLogger(LogPassExpXPathFromDBFasad.class);
    ...
    public LogPassExpXPathFromDBFasad(String id)
    {
    	this.id = id;
