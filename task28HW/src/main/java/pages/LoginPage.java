...
public class LoginPage extends Page
{
    ...
    public LoginPage(WebDriver webdriver)
    {
        ...
        LoginPage.super.logger.debug(super.getType() + " page is created");
    }
	...
	public boolean isLogLinkPresents(String expectedXPath) {
		...
		try
		{
			...
			LoginPage.super.logger.warn(getClass().getName() + ": element with given expected XPath is not defined for this page");
		}
		catch (TimeoutException e)
		{
			LoginPage.super.logger.error(getClass().getName() + " TimeoutException: " +  e.getMessage());
		}
		catch (Exception e)
		{
			LoginPage.super.logger.error(getClass().getName() + " Exception: " +  e.getMessage());
			throw e;
		}
		return false;
	}
